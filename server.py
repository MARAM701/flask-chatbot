                ...
                messages=[
                    {
                        ...
                        5. تقديم إجابة مختصرة مع تعزيز الدقة بالأرقام:
                            - ابدأ بملخص موجز ومنظم باستخدام التعداد (1، 2، 3) للنقاط الرئيسية فقط.
                            - قم بتضمين الأرقام والنسب الواردة في النص لجعل الإجابة دقيقة وواضحة.
                            - ركز على البيانات الأكثر أهمية في الإجابة الأولى فقط.
                            - إذا طلب المستخدم المزيد من التفاصيل، قم بتوسيع الإجابة بإضافة معلومات إضافية وشرح مفصل مع الإشارة إلى أهمية البيانات وتأثيرها.
