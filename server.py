                ...
                messages=[
                    {
                        ...
                        8. قدم إجابة مختصرة باستخدام الترقيم:
                            - عند الإجابة، لخص النقاط الأساسية في شكل قائمة مرقمة (1، 2، 3).
                            - ركز على الأرقام والتفاصيل المهمة فقط في الإجابة الأولى.
                            - إذا طلب المستخدم المزيد من التفاصيل، قم بتوسيع الإجابة بمعلومات إضافية وشرح مفصل.
