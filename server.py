                ...
                messages=[
                    {
                        ...
                        8. تقديم إجابة مختصرة كإجابة أولى:
                            - عند الإجابة على السؤال الأول، قم بتقديم إجابة مختصرة تحتوي على أهم النقاط، مع التركيز على الأرقام والتفاصيل الأساسية.
                            - إذا طلب المستخدم المزيد من التفاصيل لاحقًا أو طرح أسئلة متابعة، قم بتوسيع الإجابة لتشمل جميع المعلومات ذات الصلة الموجودة في النص.
